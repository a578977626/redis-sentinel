...
public class SentinelGo {
	...
	//
	// JedisSentinelPool redisSentinelJedisPool = new
...
//	private static JedisPool jedisPool = null;
	...
	static {
		Set<String> sentinels = new HashSet<String>();
		String prix = "192.168.115.131";
		String hostAndPort1 = prix+":26379";
		String hostAndPort2 = prix+":26479";
		String hostAndPort3 = prix+":26579";
		sentinels.add(hostAndPort1);
		sentinels.add(hostAndPort2);
		sentinels.add(hostAndPort3);

		String clusterName = "def_master";
		String password = "123";

		jedisPool = new JedisSentinelPool(clusterName, sentinels, password);
		
		//use the common RedisService and common RedisPool not something like 'Sentinel'
		/*
		...
		jedisPool = new JedisPool( config,"192.168.115.131", 6379,10000,"123");
		 */
...
//	}
	...
	public Jedis getJedis() {
		System.out.println("CurrentHost: "+jedisPool.getCurrentHostMaster().getHost());
		System.out.println("CurrentPost:"+jedisPool.getCurrentHostMaster().getPort());
		System.out.println("localhost:"+jedisPool.getCurrentHostMaster().getLocalHostQuietly());
		System.out.print("getNumActivegetNumActive:");
		System.out.println(jedisPool.getNumActive());
		System.out.print("getNumIdle:");
		System.out.println(jedisPool.getNumIdle());
		return jedisPool.getResource();
	}

	private static final SentinelGo SentinelGo = new SentinelGo();
	 ...
	 * @return
	 */
	public static SentinelGo getInstance() {
		return SentinelGo;
	}
...
////		SentinelGo sentinelGo = SentinelGo.getInstance();
//		SentinelGo.Strings strings = SentinelGo.new Strings();
